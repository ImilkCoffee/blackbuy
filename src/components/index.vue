  ...
  <div>
          ...
          <div class="left-705">
            <div class="banner-img">
              <div id="focus-box" class="focus-box">
                <el-carousel>
                  <el-carousel-item v-for="item in sliderlist" :key="item" class="slider">
                    <img :src="item.img_url" alt class="sliderimg">
                  </el-carousel-item>
                </el-carousel>
              </div>
            </div>
    ...
    <div class="section" v-for="item in goodlist">
      <div class="main-tit">
        ...
        <p>
          <a href="/goods/43.html" v-for="it in item.level2cateid">{{it.subcatetitle}}</a>
          <a href>
            更多
            <i>+</i>
          </a>
